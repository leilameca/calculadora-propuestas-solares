...
const document=buildProposalDocument({company:{name:"EILEN Electric Service",rnc:"1-31-00000-1",phone:"809-555-0147",email:"propuestas@eilen.do",address:"Santiago, República Dominicana",slogan:"Ingeniería que transforma energía",primaryColor:"#0F4C5C",secondaryColor:"#2F7D32",accentColor:"#F2A900",proposalValidityDays:15},customer:{name:"Grupo Herrera",nic:"78995956",address:"Av. Circunvalación, Santiago"},project:{name:"Sistema Solar Fotovoltaico",city:"Santiago",utility:"EDENORTE",tariff:"BTS-1",systemType:"On-Grid",panelWatts:590,inverter:"Solis S6 10 kW"},consumption,result,quoteItems,proposalNumber:"PROP-2026-012"});
async function main(){await mkdir("qa-docx",{recursive:true});await writeFile("qa-docx/sample-proposal.docx",await Packer.toBuffer(document));}
