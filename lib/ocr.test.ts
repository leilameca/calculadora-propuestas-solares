...
describe("parser OCR de facturas eléctricas",()=>{
  ...
  it("deriva a ingreso manual una factura sin campos ni histórico reconocible",()=>{
  ...
  it("acepta un historial reconocible de EDESUR mediante el parser genérico",()=>{
    const result=parseElectricInvoice(`EDESUR\nNOMBRE O RAZON SOCIAL: Cliente Sur SRL\nNIC: 1234567\nDIRECCIÓN: Santo Domingo\nTARIFA: BTS-2\nEne 2026 410 kWh\nFeb 2026 430 kWh\nMar 2026 420 kWh`);
